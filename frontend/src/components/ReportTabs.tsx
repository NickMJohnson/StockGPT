...
const tabConfig: Array<{ key: TabKey; label: string; icon: typeof FileText }> = [
  { key: "income", label: "Income Statement", icon: BarChart3 },
  { key: "balance", label: "Balance Sheet", icon: Wallet },
  { key: "cashflow", label: "Cash Flow", icon: PieChart },
  { key: "ratios", label: "Key Ratios", icon: FileText },
];
